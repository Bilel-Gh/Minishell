...
void ft_set_quotes_if_nul(char *name, char **value_for_export, char **env_to_add_export);
void ft_add_and_free_export(char *name, t_global_exec **g_exec, char *value_for_export, char *env_to_add_export);
...
int ft_get_index_to_export(char *const *tab, char *name, int i, t_var_add_to_export *vars);
...
int ft_do_gestion_expand(int **type_args, t_global_parsing **g_pars, char **env, t_expande_var *v);
void ft_gestion_dollar_expand(int *const *type_args, const int *nb_args, t_global_parsing *const *g_pars, t_expande_var *v);
void ft_gestion_digit_expand(t_global_parsing *const *g_pars, t_expande_var *v);
...
void ft_init_var_clean_null(char **old_arg, const int *size_db_arr, t_clean_null_var *var);
...
void ft_fill_new_args(const char *args_con, const int *info, t_expand_join *s_ex_join);
int ft_init_s_ex_join(char *args_con, const char *expande, int s_extract, t_expand_join *s_ex_join);
char *ft_malloc_expand(const char *args_con, const char *expande, int s_extract, char *new_args);
